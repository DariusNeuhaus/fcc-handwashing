var app = (function () {
    ...
    /* src\HowTo.svelte generated by Svelte v3.43.1 */
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="./hwa.png" alt="How to wash your hands." class="svelte-1ghtied"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-spo85i");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progression-container svelte-spo85i");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-1749r1f");
    			attr(div0, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "class", "start svelte-1749r1f");
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function startTimer() {
    		...
    		const timer = setInterval(
    			() => {
    				$$invalidate(0, secondLeft--, secondLeft);
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h1, "class", "svelte-ynhjqo");
    			attr(a0, "href", "https://www.who.int/gpsc/clean_hands_protection/en/");
    			attr(a1, "href", "https://freesound.org/people/metrostock99/sounds/345086/");
    			if (!src_url_equal(audio_1.src, audio_1_src_value = "splash.mp3")) attr(audio_1, "src", audio_1_src_value);
    			attr(h3, "class", "svelte-ynhjqo");
    		},
    		m(target, anchor) {
